...
In $10^5$ replications, the empirical $p$-values for the omnibus hypotheses were 
$0$, $0.464$, and $0$, respectively.
The upper 99\% confidence bounds for the actual $p$-values is 
$4.61 \times 10^{-5}$ for the two estimated $p$-values of 0, and 
the lower 99\% confidence bound for the non-zero estimated $p$-value is 0.460.
