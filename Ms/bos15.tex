...
\begin{table}[htbp]
  \centering
  \footnotesize 
  \caption{Average correlation between SET and final exam scores, by course number}
    \begin{tabular}{lrrr}
    \toprule 
                        & strata & $\bar{\rho}$  & $p$-value  \\
   \midrule
    Overall &        21 &     0.89 &       0.09  \\
    History &         5 &    0.79 &       0.01  \\
    Macroeconomics &  5 &    0.30 &       0.19  \\
    Microeconomics &   5 &   -0.04 &       0.55  \\
    Political science & 3 &  -0.08 &       0.62  \\
    Sociology &      3 &    -0.07 &       0.61  \\
    \bottomrule
    \end{tabular}%
 \label{tab:finalexam}%
...
The average correlation is especially high in History (1.61). 
The average correlation coefficients are also high in Macroeconomics (0.77), Sociology (0.71), 
