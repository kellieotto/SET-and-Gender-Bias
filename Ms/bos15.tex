...
History ($p$-value 0.01), Microeconomics ($p$-value 0.01), Macroeconomics ($p$-value 0.04), Political Science ($p$-value 0.06), and 
...
The new analysis supports their overall conclusions, in some cases substantiall more strongly 
...
from the stratified permutation distribution of the test statistic, avoiding
...
where female students tended to rate the actual female instructor significantly lower.
...
In $10^4$ replications, the empirical $p$-values for the omnibus hypotheses were 
$0$, $0.466$, and $0$, respectively.
The upper 99\% confidence bounds for the actual $p$-values is 
$4.6 \times 10^{-4}$ for the two estimated $p$-values of 0, and 
$0.478$ for the non-zero estimated $p$-value 
(the upper bounds were obtained by inverting Binomial hypothesis tests).
...
In both experiments, students generally gave higher SET when they \emph{thought} the instructor
...
SET are biased against female instructors:
